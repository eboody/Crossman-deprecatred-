 ...
 * {@link HiitTimer.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HiitTimer#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HiitTimer extends android.support.v4.app.Fragment {
     ...
     * @return A new instance of fragment HiitTimer.
     */
    // TODO: Rename and change types and number of parameters
    public static HiitTimer newInstance(String param1, String param2) {
        HiitTimer fragment = new HiitTimer();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*create references to the views and set their listeners*/
    ...
    public void startTimer() {
        ...
        new CountDownTimer(hours * 3600000 + minutes * 60000 + seconds * 1000, 1000) { // adjust the milli seconds here
            ...
            public void onFinish() {
                //when done set all back to 0 and play a beep
                hoursView.setText("0");
